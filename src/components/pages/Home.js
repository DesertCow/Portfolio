      ...
      <div className="d-flex m-4 p-3 justify-content-center align-items-center appZone flex-row">
        <div className="row d-flex px-5">
          ...
          <div className="d-flex m-2 justify-content-evenly">
            ...
            <div className="d-flex row AppBox mt-5">
              <h2 className="flex-row text-center mt-3 notey">Notey</h2>
          ...
          <div className="d-flex m-2 justify-content-evenly">
            ...
            <div className="d-flex row AppBox mt-5">
              <h2 className="flex-row text-center mt-3 wxDashboard">Wx Dashboard </h2>
          ...
          <div className="d-flex m-2 justify-content-evenly">
            <div className="d-flex row AppBox mt-5">
              <h2 className="flex-row text-center mt-3">NoSQL: Social Network API </h2>
            ...
            <div className="d-flex row AppBox mt-5">
              <h2 className="flex-row text-center mt-3">ORM: E-Commerce Backend</h2>
